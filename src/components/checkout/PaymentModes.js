...
const PaymentModes = ( { input, handleOnChange } ) => {
	...
	return (
		<div className="mt-3">
			...
			<div className="form-check woo-next-payment-input-container mt-2">
				<label className="form-check-label">
					<input onChange={ handleOnChange } value="ppec_paypal" className="form-check-input mr-3" name="paymentMethod" type="radio" checked={'ppec_paypal' === paymentMethod}/>
			...
			<div className="form-check woo-next-payment-input-container mt-2">
				<label className="form-check-label">
					<input onChange={ handleOnChange } value="woocommerce_payments" className="form-check-input mr-3" name="paymentMethod" type="radio" checked={'woocommerce_payments' === paymentMethod}/>
					<span className="woo-next-payment-content">Credit Card</span>
				</label>
			</div>			
